let resumeData = {
  ...
  socialLinks: [
    ...
    },
    {
      ...
      url: "https://drive.google.com/file/d/1U-Xdhn-67EGOmCacs3BN47TGMUkRyOUZ/view?usp=sharing",
      className: "fa fa-cloud-download",
    },
  ],
  aboutme1:
    "Mi nombre es Tomás Edelcopp. Nací en Buenos Aires, Argentina, y desde siempre sentí una fuerte curiosidad por la tecnología. En 2022 comencé a formarme de manera autodidacta y, al poco tiempo, completé un bootcamp intensivo en desarrollo web. Actualmente curso el segundo año de la Tecnicatura Superior en Desarrollo de Software, con el objetivo de seguir ampliando mis conocimientos y consolidar mi perfil profesional. Hoy trabajo como desarrollador backend en RethinkTheWay, donde participo en la integración de plataformas y el desarrollo de servicios que optimizan procesos de comunicación y gestión de datos. Esta experiencia ha sido fundamental para afianzar mis conocimientos y seguir creciendo dentro del área.",
  aboutme2:
    "Comencé mi camino profesional trabajando de forma freelance en proyectos personales como Finanzas Ya! y Darwin Studio Code, donde pude aplicar lo aprendido de forma práctica y asumir cada etapa del desarrollo por mi cuenta. Estas experiencias fueron clave para desarrollar autonomía, adaptarme a distintos contextos y fortalecer mis habilidades blandas, especialmente en la comunicación con clientes, la gestión de requerimientos y la organización del trabajo. Más adelante, me sumé al equipo de Garden Productions, una empresa argentina con clientes en Estados Unidos, donde trabajé en proyectos reales junto a otros profesionales y seguí consolidando mis conocimientos en un entorno técnico más estructurado. Me interesa seguir tomando desafíos freelance, adaptándome a distintos entornos y tecnologías, y enfrentando proyectos diversos que me permitan seguir aprendiendo, incorporar nuevas herramientas y aportar valor desde mi lugar en equipos colaborativos enfocados en soluciones estables y escalables.",
  aboutme3:
    "Hoy trabajo como desarrollador backend en RethinkTheWay, donde participo en la integración de plataformas y el desarrollo de servicios que optimizan procesos de comunicación y gestión de datos. Esta experiencia ha sido fundamental para afianzar mis conocimientos y seguir creciendo dentro del área.",
