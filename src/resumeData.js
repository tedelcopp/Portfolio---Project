let resumeData = {
  ...
  aboutme2:
    "A lo largo de mi formación, también trabajé en proyectos freelance como Finanzas Ya! y Darwin Studio Code, que me permitieron no solo aplicar lo aprendido en desarrollo, sino también fortalecer mis habilidades blandas, especialmente en la comunicación con clientes, la gestión de requerimientos y la organización del trabajo. Me interesa seguir aprendiendo, explorar nuevas herramientas y frameworks, y aportar valor desde mi lugar en proyectos colaborativos enfocados en soluciones estables y escalables.",
